...
def upload_folder_to_s3(local_folder, bucket_name=BUCKET_NAME, s3_folder='dotnet-testing/', region_name=REGION_NAME):
...
if __name__ == "__main__":
    ...
    local_folder = "C:/Users/charanarivarasan/Documents/SwiftCart-Modernized"  # Local folder to upload
